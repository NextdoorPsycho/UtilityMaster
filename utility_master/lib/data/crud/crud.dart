...
class Crud {
  ...
  static FireCrud<UserCapabilities> userCapabilities(String uid) =>
      FireCrud<UserCapabilities>(
  ...
  static FireCrud<UserSettings> userSettings(String uid) =>
      FireCrud<UserSettings>(
          usageTracker: (event) => usage += event,
          collection: FirebaseFirestore.instance.collection("user/$uid/data"),
          toMap: (t) => t.toMap(),
