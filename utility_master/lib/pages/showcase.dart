  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
      ...
      children: [
        ...
        ShadRadioGroupFormField<_NotifyAbout>(
          label: const Text('Notify me about'),
          items: _NotifyAbout.values.map(
            (e) => ShadRadio(
              value: e,
        ...
        ShadSelect<String>(
          ...
          selectedOptionBuilder: (context, value) {
            final timezone = _timezones.entries
              ...
              children: [
                ShadButton.outline(
                  ...
                  onPressed: () => showShadSheet(
                    ...
                    context: context,
                    builder: (context) =>
                        const _EditProfileSheet(side: ShadSheetSide.top),
                  ),
                ),
                ShadButton.outline(
                  width: 100,
                  ...
                  onPressed: () => showShadSheet(
                    ...
                    context: context,
                    builder: (context) =>
                        const _EditProfileSheet(side: ShadSheetSide.bottom),
                  ),
                ),
              ],
            ),
              ...
              children: [
                ShadButton.outline(
                  ...
                  onPressed: () => showShadSheet(
                    ...
                    context: context,
                    builder: (context) =>
                        const _EditProfileSheet(side: ShadSheetSide.right),
                  ),
                ),
                ShadButton.outline(
                  width: 100,
                  ...
                  onPressed: () => showShadSheet(
                    ...
                    context: context,
                    builder: (context) =>
                        const _EditProfileSheet(side: ShadSheetSide.left),
                  ),
                ),
              ],
            ),
...
List<Widget> _getTimezonesWidgets(ShadThemeData theme) {
  final widgets = <Widget>[];
  for (final zone in _timezones.entries) {
    widgets.add(
      Padding(
        padding: const EdgeInsets.fromLTRB(32, 6, 6, 6),
        child: Text(
...
class _CardNotifications extends StatefulWidget {
  const _CardNotifications();

  @override
  State<_CardNotifications> createState() => _CardNotificationsState();
}

class _CardNotificationsState extends State<_CardNotifications> {
...
class _EditProfileSheet extends StatelessWidget {
  const _EditProfileSheet({super.key, required this.side});
