...
class MonochromeShadSlateColorScheme extends ShadColorScheme {
  ...
  const MonochromeShadSlateColorScheme.light({
    ...
    super.foreground = const Color(0xff1a1a1a), // Dark grey, for strong contrast against background
    ...
    super.primaryForeground = const Color(0xfff8fafc), // No change, maintains high visibility
  ...
  const MonochromeShadSlateColorScheme.dark({
    ...
    super.selection = const Color(0xff2b2b2b), // Dark grey, distinct from other elements for focus
  });
}
